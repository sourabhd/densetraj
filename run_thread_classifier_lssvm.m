function [model, predicted_label, accuracy, decision_values, probability_estimates, ...
        ...
        cl, tr, te, tr_v, te_v, fileorder, ...
        retain_frac_threads, Linear_K_video, Linear_KK_video) 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    cv_video = do_binary_cross_validation(training_labels_vector_video, ...
        [ (1:num_tr_video)' Linear_K_video], opt_video, n_fold_video); 

    lambda = 10^-3 * num_tr_video; 
    [alphas,b, cvErrs, cvWs, cvBs] = ML_Ridge.kerRidgeReg_cv(Linear_K_video, ...
        training_labels_vector_video, lambda, ones(num_tr_video,1));
    w = Linear_K_video*alphas;            
    decision_values_video = Linear_KK_video * alphas + b; 
